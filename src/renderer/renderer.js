...
const THEMES = {
  ...
  amiga: { '--teal-light': '#0a6fd0', '--teal': '#0055aa', '--teal-dark': '#003a78', '--bar-fg': '#ffffff', '--menu-bg': '#ff8800', '--menu-fg': '#000000', '--btn-hover': 'rgba(255,255,255,0.18)', '--btn-press': 'rgba(255,136,0,0.40)', '--btn-active-bg': '#ff8800', '--btn-active-fg': '#000000', '--head-bg': '#ffffff', '--head-fg': '#000000', '--right-bg': '#0a6fd0', '--right-fg': '#ffffff', '--right-hover': 'rgba(255,136,0,0.30)' }, // iMac G3 Bondi Blue + icy translucent // Sony VAIO 505 (magnesium silver + VAIO violet)     // Ubuntu aubergine
};
const THEME_LABELS = [
  ...
  ['aquastripe', 'Mac OS X 10.0 (Aqua)'], ['thinkpad', 'ThinkPad'], ['pc98', 'NEC PC-98'], ['amiga', 'Amiga Workbench'],
];
